...
const translations: Record<Locale, TranslationRecord> = {
  en: {
    ...
    footer: {
      ...
      email: "Email: inkumburwazibwanacyambwe@gmail.com",
      bookings: "Bookings: inkumburwazibwanacyambwe@gmail.com",
    ...
    events: {
      ...
      event: {
        ...
        kwibohoraCulturalNight: {
          title: "Kwibohora Cultural Night",
          description: "Presented by Riders Lounge with a live performance by Inkumburwa Cultural Troupe. Free entrance, happy hour from 4 PM to 8 PM, and reservations at +250 784 836 839.",
          date: "July 4, 2026",
          location: "Riders Lounge - Kigali Height",
          time: "7:00 PM",
          email: "inkumburwazibwanacyambwe@gmail.com",
          phone: "+250 784 836 839",
        },
      },
    },
    about: {
  ...
  fr: {
    ...
    footer: {
      ...
      email: "E-mail : inkumburwazibwanacyambwe@gmail.com",
      bookings: "Réservations : inkumburwazibwanacyambwe@gmail.com",
    ...
    events: {
      ...
      event: {
        ...
        kwibohoraCulturalNight: {
          title: "Nuit culturelle Kwibohora",
          description: "Présentée par Riders Lounge avec une performance live de Inkumburwa Cultural Troupe. Entrée gratuite, happy hour de 16h à 20h, et réservations au +250 784 836 839.",
          date: "4 juillet 2026",
          location: "Riders Lounge - Kigali Height",
          time: "19:00",
          email: "inkumburwazibwanacyambwe@gmail.com",
