  ...
  return (
    <div className="fixed bottom-6 right-6 flex flex-col gap-4 z-50">
      <a
        ...
        className="flex items-center justify-center w-14 h-14 rounded-full bg-green-500 text-white shadow-lg hover:bg-green-600 transition-all duration-300"
      ...
      <a
        ...
        className="flex items-center justify-center w-14 h-14 rounded-full bg-emerald-600 text-white shadow-lg hover:bg-emerald-700 transition-all duration-300"
        aria-label="Call now"
      >
