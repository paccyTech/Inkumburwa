  ...
  return (
    <div className="fixed bottom-4 right-4 flex flex-col gap-3 z-50">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="flex items-center justify-center w-12 h-12 rounded-full bg-gradient-to-r from-pink-500 via-purple-500 to-pink-600 text-white shadow-lg hover:from-pink-600 hover:via-purple-600 hover:to-pink-700 transition-all duration-300"
      ...
      {/* YouTube Button */}
      <a
        href="https://youtube.com/@itorero_inkumburwa?si=5bFcofH1__4HT3Ip"
        target="_blank"
        rel="noopener noreferrer"
        className="flex items-center justify-center w-12 h-12 rounded-full bg-red-600 text-white shadow-lg hover:bg-red-700 transition-all duration-300"
      ...
      <a
        ...
        className="flex items-center justify-center w-12 h-12 rounded-full bg-emerald-600 text-white shadow-lg hover:bg-emerald-700 transition-all duration-300"
        aria-label="Call now"
      >
